    ...
    <div class="h-screen w-full bg-[url('/assets/seweybg.jpg')] bg-cover bg-no-repeat bg-fixed">
        ...
        <div class="flex-1 flex items-center justify-center">
            <div class="mt-10">
                ...
                <button @click="this.$router.push('/create')" class="text-white bg-white/30 hover:bg-white/20 text-lg px-3 py-1.5 rounded-lg font-semibold hover:text-gray-100 transition ease-in-out duration-[250ms]">Add Link</button>
                <div v-for="link in links" :key="link" class="rounded-lg bg-white/30 hover:bg-white/20 transition ease-in-out duration-[150ms] backdrop-blur-lg py-2 px-2 w-[50rem] my-3">
